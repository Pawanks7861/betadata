            ...
            <thead>
                ...
                <tr>
                    ...
                    <th colspan="6" class="daily_report_head">
                        <span class="daily_report_label" style="display: ruby;"> <input type="text" id="area_of_work" name="area_of_work" class="form-control" style="width:100%;" value="<?php echo isset($msh_form->shi) ? $msh_form->shi : '' ?>"></span>
                    </th>
                </tr>
                <tr>
                    <th colspan="2" class="daily_report_head">
                    ...
                    <th colspan="6" class="daily_report_head">
                        <span class="daily_report_label" style="display: ruby;"> <input type="text" id="scaffold_supervisor" name="scaffold_supervisor" class="form-control" style="width:100%;" value="<?php echo isset($msh_form->shi) ? $msh_form->shi : '' ?>"></span>
                    </th>
            ...
            <tbody>
                ...
                ?>
                    <tr class="main">
                        ...
                        <td> <span class="daily_report_label" style="display: ruby;"> <input type="text" id="items[<?= $sr ?>][comments]" name="items[<?= $sr ?>][comments]" class="form-control" style="width:100%;" value="<?php echo $ckeck;  ?>"></span></td>
                        <td>
