    ...
    <div class="col-md-4 task-single-col-right">
        ...
        <div class="task-info task-info-hourly-rate">
            <h5 class="tw-inline-flex tw-items-center tw-space-x-1.5">
                <i class="fa-regular fa-bookmark fa-fw fa-lg task-info-icon pull-left"></i>
                <?php echo 'Category '; ?>: <span class="tw-text-neutral-800">
            
                    <?php echo get_group_name_by_id($task->category); ?>
        ...
        <?php if ($task->current_user_is_creator || staff_can('edit',  'tasks')) { ?>
            <div class="task-info task-info-hourly-rate">
                <h5 class="tw-inline-flex tw-items-center tw-space-x-1.5">
                    <i class="fa-regular fa-file-lines fa-fw fa-lg task-info-icon pull-left"></i>
                    <?php echo 'Price '; ?>: <span class="tw-text-neutral-800">
                        <?php echo  '₹' . app_format_number($task->price); ?>
            ...
            <div class="task-info task-info-hourly-rate">
                <h5 class="tw-inline-flex tw-items-center tw-space-x-1.5">
                    <i class="fa-regular fa-weight fa-fw fa-lg task-info-icon pull-left"></i>
                    <?php echo 'Measurement '; ?>: <span class="tw-text-neutral-800">
                        <?php $unit_name = get_task_unit_by_id($task->unit); ?>
                        <?php echo $task->set_total_work . ' (' . $unit_name .')'; ?>
                    </span>
                </h5>
            </div>
