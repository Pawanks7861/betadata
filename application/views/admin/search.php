        ...
        <?php foreach ($data['result'] as $_result) {
            ...
            switch ($data['type']) {
                ...
                case 'projects':
                    ...
                    break;
                case 'pur_order':
                    $output = '<a href="' . admin_url('purchase/purchase_order/' . $_result['id']) . '">' . e($_result['pur_order_name']) . '</a>';
                    break;
                case 'pur_vendor':
                    $output = '<a href="' . admin_url('purchase/vendor/' . $_result['userid']) . '">' . e($_result['company']) . '</a>';
                    break;
                case 'items':
                    $output = '<a href="' . admin_url('purchase/items/' . $_result['id']) . '">' . e($_result['commodity_code']) . '</a>';
                    break;
            }
        ?>
