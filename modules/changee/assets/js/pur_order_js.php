...
function coppy_pur_estimate(){
  ...
  if(pur_estimate != ''){
    $.post(admin_url + 'changee/coppy_pur_estimate/'+pur_estimate).done(function(response){
        response = JSON.parse(response);
        if(response){ 
...
function coppy_sale_invoice(){
  ...
  if(sale_invoice != ''){
    $.post(admin_url + 'changee/coppy_sale_invoice_po/'+sale_invoice).done(function(response){
        response = JSON.parse(response);
