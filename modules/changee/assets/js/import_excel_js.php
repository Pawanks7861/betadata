<script>
   ...
   (function($) {
    ...
    "use strict";
      ...
      if('<?php echo changee_pur_html_entity_decode($active_language) ?>' == 'vietnamese')
      {
        $( "#dowload_file_sample" ).append( '<a href="'+ site_url+'modules/changee/uploads/file_sample/Sample_import_commodity_file_vi.xlsx" class="btn btn-primary" ><?php echo _l('download_sample') ?></a><hr>' );

      }else{
        $( "#dowload_file_sample" ).append( '<a href="'+ site_url+'modules/changee/uploads/file_sample/Sample_import_commodity_file_en.xlsx" class="btn btn-primary" ><?php echo _l('download_sample') ?></a><hr>' );
      }
...
function uploadfilecsv(){
  "use strict";
    ...
    if(<?php echo  changee_pur_check_csrf_protection(); ?>){
    ...
    $.ajax({ 
      url: admin_url + 'changee/import_file_xlsx_commodity', 
      method: 'post', 
      data: formData, 
      contentType: false, 
      processData: false
