...
var data_send_mail = {};
  <?php if(isset($send_mail_approve)){ 
    ...
    data_send_mail.rel_id = <?php echo changee_pur_html_entity_decode($payment_invoice->id); ?>;
    data_send_mail.rel_type = 'payment_request';
    data_send_mail.addedfrom = <?php echo changee_pur_html_entity_decode($payment_invoice->requester); ?>;
...
function send_request_approve(id){
  "use strict"; 
    var data = {};
    data.rel_id = <?php echo changee_pur_html_entity_decode($payment_invoice->id); ?>;
    data.rel_type = 'payment_request';
    data.addedfrom = <?php echo changee_pur_html_entity_decode($payment_invoice->requester); ?>;
