<script>
	...
	initDataTable(table_manage_order_return, admin_url+'changee/table_manage_order_return',[],[], InvoiceServerParams, [0 ,'desc']);
	...
	function init_order_return(id) {
		"use strict";
		load_small_table_item_proposal(id, '#order_return_sm_view', 'delivery_id', 'changee/view_order_return', '.order_return_sm');
	}
...
function open_warehouse_modal(iv, order_return_id) {
    "use strict";
      ...
      $("#warehouse_modal_wrapper").load("<?php echo admin_url('changee/changee/open_warehouse_modal'); ?>", {
