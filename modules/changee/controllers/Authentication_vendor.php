...
{   
    ...
    public function login()
    {
        if (changee_is_vendor_logged_in()) {
            redirect(site_url('changee/vendors_portal'));
        }
        ...
        if ($this->form_validation->run() !== false) {
            ...
            $this->announcements_model->set_announcements_as_read_except_last_one(changee_get_vendor_contact_user_id());
    ...
    public function register()
    {
        ...
        if ($this->input->post()) {
            if ($this->form_validation->run() !== false) {
                ...
                $clientid = $this->changee_model->add_vendor([
                ...
                if ($clientid) {
                    ...
                    $this->changee_model->require_confirmation($clientid);
                    $this->load->model('authentication_vendor_model');
                    ...
                    $redUrl = site_url('changee/authentication_vendor/login');
