...
class Vendor_merge_fields extends App_merge_fields
{
    ...
    public function format($_contact, $vendor_id, $contact_id = '')
    {
        ...
        $fields['{companyname}']          = changee_get_vendor_company_name($vendor_id);

        $fields['{vendor_portal_url}']          = site_url('changee/authentication_vendor/login');
        $fields['{vendor_portal_link}']          = site_url('changee/authentication_vendor/login');
