...
class Debit_note_pdf extends App_pdf
{
    ...
    {
        $GLOBALS['changee_debit_note_pdf'] = $debit_note;

        parent::__construct();


        $this->debit_note        = $debit_note;
        $this->debit_note_number = changee_format_debit_note_number($this->debit_note->id);
    ...
    protected function file_path()
    {
        ...
        $actualPath = APP_MODULES_PATH . '/changee/views/debit_notes/debit_notepdf.php';
