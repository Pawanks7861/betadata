...
$info_right_column .= '<br /><span style="color:rgb(' . changee_debit_note_status_color_pdf($debit_note->status) . ');text-transform:uppercase;">' . format_credit_note_status($debit_note->status, '', false) . '</span>';

// Add logo
$info_left_column .= changee_get_po_logo(150);
...
$debit_note_info .= '<div style="color:#424242;">';
    $debit_note_info .= changee_format_vendor_info($debit_note, 'debit_note', 'billing');
$debit_note_info .= '</div>';
