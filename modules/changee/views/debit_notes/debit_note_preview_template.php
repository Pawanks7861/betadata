   ...
   <div class="panel_s">
      <div class="panel-body">
         ...
         <div class="row mtop10">
            <div class="col-md-3">
               <?php echo changee_format_debit_note_status($debit_note->status);  ?>
            </div>
            <div class="col-md-9">
               ...
               <div class="pull-right _buttons">
                  <?php if(has_permission('changee_debit_notes','','edit') && $debit_note->status != 3){ ?>
                  <a href="<?php echo admin_url('changee/debit_note/'.$debit_note->id); ?>" class="btn btn-default btn-with-tooltip" data-toggle="tooltip" title="<?php echo _l('edit',_l('debit_note_lowercase')); ?>" data-placement="bottom">
                  ...
                  <div class="btn-group">
                     ...
                     <ul class="dropdown-menu dropdown-menu-right">
                        <li class="hidden-xs"><a href="<?php echo admin_url('changee/changee_debit_note_pdf/'.$debit_note->id.'?output_type=I'); ?>"><?php echo _l('view_pdf'); ?></a></li>
                        <li class="hidden-xs"><a href="<?php echo admin_url('changee/changee_debit_note_pdf/'.$debit_note->id.'?output_type=I'); ?>" target="_blank"><?php echo _l('view_pdf_in_new_window'); ?></a></li>
                        <li><a href="<?php echo admin_url('changee/changee_debit_note_pdf/'.$debit_note->id); ?>"><?php echo _l('download'); ?></a></li>
                        <li>
                           <a href="<?php echo admin_url('changee/changee_debit_note_pdf/'.$debit_note->id.'?print=true'); ?>" target="_blank">
                           <?php echo _l('print'); ?>
                           </a>
                        </li>
                     </ul>
                  ...
                  <a href="#" class="btn btn-default" onclick="send_debit_note('<?php echo changee_pur_html_entity_decode($debit_note->id); ?>'); return false;">
                  ...
                  <div class="btn-group">
                     ...
                     <ul class="dropdown-menu dropdown-menu-right">
                        ...
                        <?php
                           if($debit_note->status == 1 && has_permission('changee_debit_notes','','edit')) { ?>
                        <li>
                        ...
                        <?php }
                           ...
                           if($debit_note->status != 2 && $debit_note->status != 3 && !$debit_note->debit_used && !$debit_note->total_refunds && has_permission('changee_debit_notes','','edit')) { ?>
                        <li>
                           <a href="<?php echo admin_url('changee/mark_debit_note_void/'.$debit_note->id); ?>">
                           <?php echo _l('debit_note_status_void'); ?>
                           </a>
                        </li>
                        <?php } else if($debit_note->status == 3 && has_permission('changee_debit_notes','','edit')) { ?>
                        <li>
                           <a href="<?php echo admin_url('changee/mark_debit_note_open/'.$debit_note->id); ?>">
                        ...
                        <li>
                           <a
                              ...
                              href="<?php echo admin_url('changee/delete_debit_note/'.$debit_note->id); ?>"
               ...
               <div id="credit-note-preview">
                  <div class="row">
                     <div class="col-md-6 col-sm-6">
                        <h4 class="bold">
                           <a href="<?php echo admin_url('changee/debit_note/'.$debit_note->id); ?>">
                           <span id="credit-note-number">
                           <?php echo changee_format_debit_note_number($debit_note->id); ?>
                           </span>
                           </a>
                        </h4>
                        <address>
                     ...
                     <div class="col-sm-6 text-right">
                        ...
                        <address>
                           <?php echo changee_format_vendor_info($debit_note, 'debit_note', 'billing', true); ?>
                        </address>
                        <?php if($debit_note->include_shipping == 1 && $debit_note->show_shipping_on_debit_note == 1){ ?>
                        <span class="bold"><?php echo _l('ship_to'); ?>:</span>
                        <address>
                           <?php echo changee_format_vendor_info($debit_note, 'debit_note', 'shipping'); ?>
                        </address>
                        <?php } ?>
                        <p class="no-mbot">
                           <span class="bold">
            ...
            <div role="tabpanel" class="tab-pane" id="invoices_credited">
               ...
               <table class="table table-bordered no-mtop">
                  ...
                  <tbody>
                     ...
                     <tr>
                        <td>
                           <a href="<?php echo admin_url('changee/changee_invoice/'.$debit['invoice_id']); ?>">
                              <?php echo changee_get_pur_invoice_number($debit['invoice_id']); ?>
                           </a>
                        </td>
                        <td>
                        ...
                        <td>
                           ...
                           <?php if(has_permission('changee_debit_notes','','delete')) { ?>
                           <a href="<?php echo admin_url('changee/delete_debit_note_applied_debit/'.$debit['id'].'/'.$debit['debit_id'].'/'.$debit['invoice_id']); ?>" class="pull-right text-danger _delete"><i class="fa fa-trash"></i></a>
                           <?php } ?>
                        </td>
                     </tr>
                     <?php } ?>
               ...
               <table class="table table-bordered no-mtop">
                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td>
                           <?php if(has_permission('changee_debit_notes','','delete')) { ?>
                           <a href="<?php echo admin_url('changee/delete_debit_refund/'.$refund['id'].'/'.$refund['debit_note_id']); ?>"
                              class="pull-right text-danger _delete">
                           <i class="fa fa-trash"></i>
                           </a>
                           <?php } ?>
                           <?php if(has_permission('changee_debit_notes','','edit')) { ?>
...
<div class="modal fade" id="send_dn" tabindex="-1" role="dialog">
  <div class="modal-dialog">
      <?php echo form_open_multipart(admin_url('changee/send_debit_note'),array('id'=>'send_dn-form')); ?>
              ...
              <div class="row">
                ...
                <div class="col-md-12">
                  <div class="checkbox checkbox-primary">
                      ...
                      <label for="attach_pdf"><?php echo _l('attach_changee_debit_note_pdf'); ?></label>
                  </div>
                </div>
...
<?php require 'modules/changee/assets/js/debit_note_preview_js.php';?>  
