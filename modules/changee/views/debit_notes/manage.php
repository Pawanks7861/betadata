     ...
     <div class="col-md-12">
      <div class="panel_s mbot10">
         <div class="panel-body _buttons">
            <?php if(has_permission('changee_debit_notes','','create')){ ?>
            <a href="<?php echo admin_url('changee/debit_note'); ?>" class="btn btn-info pull-left display-block">
...
<?php init_tail(); ?>
<?php require 'modules/changee/assets/js/manage_debit_note_js.php';?>  
</body>
</html>
