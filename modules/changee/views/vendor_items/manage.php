      ...
      <div class="col-md-12">
        <div class="panel_s">
          <div class="panel-body">
            ...
            <hr />
            <a href="<?php echo admin_url('changee/new_vendor_items'); ?>" class="btn btn-info mbot10"><?php echo _l('new'); ?></a>
            <div class="row">
              <div class="col-md-3">
              ...
              <div class="modal-dialog" role="document">
                 <div class="modal-content">
                    ...
                    <div class="modal-body">
                       <?php if(is_admin() || has_permission('changee_vendor_items', '', 'delete')){ ?>
                    ...
                    <div class="modal-footer">
                       ...
                       <?php if(has_permission('changee_vendor_items','','delete') || is_admin()){ ?>
...
<?php require 'modules/changee/assets/js/manage_vendor_items_js.php';?>