...
<div id="wrapper">
   <div class="content">
               ...
               <div class="panel-body">
                <?php echo form_hidden('item_id',$item_id); ?>
                  ...
                  <div class="row row-margin-bottom">
                    <div class="col-md-5  ">
                        <?php if (has_permission('changee_items', '', 'create') || is_admin()) { ?>
                        ...
                        <a href="<?php echo admin_url('changee/import_xlsx_commodity'); ?>" class="btn btn-success pull-left display-block mr-4 button-margin-r-b">
                        ...
                        <div class="modal-dialog" role="document">
                           <div class="modal-content">
                              ...
                              <div class="modal-body">
                                 ...
                                 <?php if(has_permission('changee_items','','delete') || is_admin()){ ?>
                                  <div class="col-md-4">
                                 ...
                                 <?php if(has_permission('changee_items','','edit') || is_admin()){ ?>
                                  <div class="row">
                                    <div class="col-md-5">
                                      <div class="form-group">
    ...
    <div class="modal" id="changee_type" tabindex="-1" role="dialog">
    <div class="modal-dialog ht-dialog-width">

          <?php echo form_open_multipart(admin_url('changee/add_commodity_list'), array('id'=>'add_changee_type')); ?>
          <div class="modal-content" >
                <div class="modal-header">
                ...
                <div class="modal-body">
                  <div class="row">
                    <div class="col-md-12">
                         <div id="changee_type_id">
                         </div>   
                     <div class="form"> 
                        <div class="col-md-12" id="add_handsontable">
                        </div>
                          <?php echo form_hidden('hot_changee_type'); ?>
                    </div>
                    </div>
                    </div>
                </div>
                <div class="modal-footer">
                     ...
                     <button id="latch_assessor" type="button" class="btn btn-info intext-btn" onclick="add_changee_type(this); return false;" ><?php echo _l('submit'); ?></button>
                </div>
                <?php echo form_close(); ?>
              </div>
              </div>
  ...
  <!-- add one commodity list sibar start-->       
    ...
    <div class="modal-dialog ht-dialog-width">
        ...
        <?php echo form_open_multipart(admin_url('changee/commodity_list_add_edit'),array('class'=>'commodity_list-add-edit','autocomplete'=>'off')); ?>
...
<?php require 'modules/changee/assets/js/item_list_js.php';?>
