			...
			<div class="col-md-12" id="small-table">
				<div class="panel_s accounting-template">
					...
					<div class="panel-body">
						...
						?>
						<input type="hidden" name="id" value="<?php echo changee_pur_html_entity_decode($id); ?>">
						<input type="hidden" name="save_and_send_request" value="false">
						<input type="hidden" name="rel_type" value="<?php echo changee_pur_html_entity_decode($rel_type); ?>">
						<input type="hidden" name="main_additional_discount" value="<?php echo changee_pur_html_entity_decode($additional_discount); ?>">
						<?php 
						...
						if($rel_type == 'sales_return_order'){
							...
							$rel_id_data = $this->changee_model->get_pur_order_for_order_return(); 
							$company_id_lable = _l('pur_vendor');;
							$company_id_data = $this->changee_model->get_vendor();
									...
									<div class="col-md-6 form-group">
										...
										<div class="input-group">
											<span class="input-group-addon">
												<?php echo changee_pur_html_entity_decode($order_return_code); ?>
											</span>
											<input type="text" name="order_return_name" class="form-control" value="<?php echo changee_pur_html_entity_decode($order_return_name); ?>" >
										</div>
									</div>
								</div>
					...
					<div class="panel-body mtop10 invoice-item">
						<div class="row <?php echo changee_pur_html_entity_decode($main_item_select_hide); ?>">
							<div class="col-md-4">
							...
							<table class="table invoice-items-table items table-main-invoice-edit has-calculations no-mtop">
								<thead>
									<tr>
										...
										<th width="10%" align="right"><?php echo changee_pur_html_entity_decode($rate_label); ?></th>
								...
								<tbody>
									<?php echo changee_pur_html_entity_decode($order_return_row_template); ?>
								</tbody>
							</table>
						</div>
						...
						<div class="col-md-12 mtop15">
							<div class="panel-body bottom-transaction">
								...
								<div class="btn-bottom-toolbar text-right">
									...
									<?php if (is_admin() || has_permission('changee_order_return', '', 'edit') || has_permission('changee_order_return', '', 'create')) { ?>
...
<?php init_tail(); ?>
<?php require 'modules/changee/assets/js/order_returns/order_return_js.php';?>
</body>
</html>
