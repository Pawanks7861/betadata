					...
					<div class="panel-body">
						...
						<div class="row">    
							<div class="col-md-3">
									...
									<?php if (has_permission('changee_order_return', '', 'create') || is_admin()) { ?>

										<a href="<?php echo admin_url('changee/order_return'); ?>" class="btn btn-primary"><?php echo _l('pur_new'); ?></a>
									<?php } ?>
...
<?php init_tail(); ?>
<?php require 'modules/changee/assets/js/manage_order_return_js.php';?>
</body>
</html>
