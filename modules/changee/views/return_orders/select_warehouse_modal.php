	...
	<div class="modal-dialog ">
		<div class="modal-content">
			...
			<div class="modal-footer">
				...
				<?php if(has_permission('changee_order_return', '', 'create') || has_permission('changee_order_return', '', 'edit')){ ?>
...
<?php require('modules/changee/assets/js/order_returns/select_warehouse_modal_js.php'); ?>
