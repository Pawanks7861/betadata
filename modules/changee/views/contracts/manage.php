						...
						<div class="row">
		                 <div class="col-md-12">
		              	...
		              	<div class="row">
		              		<div class="col-md-12">    
		                        <div class="_buttons">
		                        	<?php if (has_permission('changee_contracts', '', 'create') || is_admin()) { ?>
			                        <a href="<?php echo admin_url('changee/contract'); ?>"class="btn btn-info pull-left mright10 display-block">
			                    ...
			                    <div class="col-md-3">
				                    ...
				                    <?php foreach($vendors as $or){ ?>
				                      <option value="<?php echo changee_pur_html_entity_decode($or['userid']); ?>"><?php echo changee_pur_html_entity_decode($or['company']); ?></option>
				                    <?php } ?>
				                  	</select>
			                    </div>
			                    <div class="col-md-3">
