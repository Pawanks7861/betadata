...
<div id="wrapper">
	<div class="content">
        ...
        <div class="panel-body">
          ...
          <div class="row">
             <div class="col-md-12">
                <p class="bold p_style" ><?php echo changee_pur_html_entity_decode($title); ?></p>
                <hr class="hr_style" />
                <div class="row">
                ...
                <div class="col-md-6 form-group">
                  ...
                  <select name="vendor" id="vendor" class="selectpicker" onchange="vendor_change(this); return false;" data-live-search="true" data-width="100%" data-none-selected-text="<?php echo _l('ticket_settings_none_assigned'); ?>" >
                    ...
                    <?php foreach($vendors as $or){ ?>
                      <option value="<?php echo changee_pur_html_entity_decode($or['userid']); ?>" <?php if(isset($contract) && $contract->vendor == $or['userid']){ echo 'selected'; }else{ if(isset($ven) && $ven == $or['userid']){ echo 'selected'; } } ?>><?php echo changee_pur_html_entity_decode($or['company']); ?></option>
                    <?php } ?>
                  </select>
                </div>
                ...
                <div class="col-md-6 form-group">
                  ...
                  <select name="project" id="project" class="selectpicker" data-live-search="true" data-width="100%" data-none-selected-text="<?php echo _l('ticket_settings_none_assigned'); ?>" >
                    ...
                    <?php foreach($projects as $pj){ ?>
                      <option value="<?php echo changee_pur_html_entity_decode($pj['id']); ?>" <?php if(isset($contract) && $contract->project == $pj['id']){ echo 'selected'; }else if(!isset($contract) && $pj['id'] == $project_id){ echo 'selected';} ?>><?php echo changee_pur_html_entity_decode($pj['name']); ?></option>
                    <?php } ?>
                  </select>
                </div>
                ...
                <div class="col-md-6 form-group">
                  ...
                  <select name="department" readonly="true" id="department" class="selectpicker" data-live-search="true" data-width="100%" data-none-selected-text="<?php echo _l('ticket_settings_none_assigned'); ?>" >
                    ...
                    <?php foreach($departments as $dpm){ ?>
                      <option value="<?php echo changee_pur_html_entity_decode($dpm['departmentid']); ?>" <?php if(isset($contract) && $contract->department == $dpm['departmentid']){ echo 'selected'; } ?>><?php echo changee_pur_html_entity_decode($dpm['name']); ?></option>
                    <?php } ?>
                  </select>
                </div>
              ...
              <div class="panel-body">
                ...
                <div class="horizontal-scrollable-tabs preview-tabs-top">
                     ...
                     <div class="horizontal-tabs">
                        <ul class="nav nav-tabs tabs-in-body-no-margin contract-tab nav-tabs-horizontal mbot15" role="tablist">
                           ...
                           <li role="presentation">
                             <a href="#tab_reminders" onclick="initDataTable('.table-reminders', admin_url + 'misc/get_reminders/' + <?php echo changee_pur_html_entity_decode($contract->id) ;?> + '/' + 'pur_contract', undefined, undefined, undefined,[1,'asc']); return false;" aria-controls="tab_reminders" role="tab" data-toggle="tab">
                          ...
                          <li role="presentation">
                             <a href="#tab_notes" onclick="get_sales_notes_contract(<?php echo changee_pur_html_entity_decode($contract->id); ?>,'changee'); return false" aria-controls="tab_notes" role="tab" data-toggle="tab">
                          ...
                          <li role="presentation">
                             <a href="#tab_tasks" onclick="init_rel_tasks_table(<?php echo changee_pur_html_entity_decode($contract->id); ?>,'pur_contract'); return false;" aria-controls="tab_tasks" role="tab" data-toggle="tab">
                             <?php echo _l('tasks'); ?>
                             </a>
                          </li>
                           <li role="presentation" >
                ...
                <div class="tab-content">
                    ...
                    <div class="col-md-12 text-right _buttons mtop10 mbot10">
                      <div class="btn-group">
                         ...
                         <ul class="dropdown-menu dropdown-menu-right">
                            <li class="hidden-xs"><a href="<?php echo admin_url('changee/pdf_contract/'.$contract->id.'?output_type=I'); ?>"><?php echo _l('view_pdf'); ?></a></li>
                            <li class="hidden-xs"><a href="<?php echo admin_url('changee/pdf_contract/'.$contract->id.'?output_type=I'); ?>" target="_blank"><?php echo _l('view_pdf_in_new_window'); ?></a></li>
                            <li><a href="<?php echo admin_url('changee/pdf_contract/'.$contract->id); ?>"><?php echo _l('download'); ?></a></li>
                            <li>
                               <a href="<?php echo admin_url('changee/pdf_contract/'.$contract->id.'?print=true'); ?>" target="_blank">
                               <?php echo _l('print'); ?>
                               </a>
                            </li>
                         </ul>

                         <a href="javascript:void(0)" onclick="send_contract('<?php echo changee_pur_html_entity_decode($contract->id); ?>'); return false;" class="btn btn-success mleft10" ><i class="fa fa-envelope" data-toggle="tooltip" title="<?php echo _l('send_to_vendor') ?>"></i></a>
                    ...
                    <div class="editable tc-content div_content">
                       <?php
                          if(empty($contract->content)){
                           ...
                           echo changee_pur_html_entity_decode($contract->content);
                          }
                          ?>
                    </div>
                  ...
                  <div role="tabpanel" class="tab-pane" id="tab_reminders">
                     <a href="#" data-toggle="modal" class="btn btn-info" data-target=".reminder-modal-pur_contract-<?php echo changee_pur_html_entity_decode($contract->id); ?>"><i class="fa fa-bell-o"></i> <?php echo _l('estimate_set_reminder_title'); ?></a>
                     <hr />
                  ...
                  <div role="tabpanel" class="tab-pane" id="payment">
                      ...
                      <tbody>
                         <?php foreach($payment as $pay) { ?>
                            <tr>
                              <td><a href="<?php echo admin_url('changee/changee_invoice/'.$pay['pur_invoice']); ?>" ><?php echo changee_get_pur_invoice_number($pay['pur_invoice']); ?></a></td>
                               ...
                               <td><?php echo changee_get_status_approve($pay['approval_status']); ?></td>
                               <td>
                  ...
                  <div role="tabpanel" class="tab-pane" id="tab_notes">
                    <br>
                     <?php echo form_open(admin_url('changee/add_pur_contract_note/'.$contract->id),array('id'=>'sales-notes','class'=>'contract-notes-form')); ?>
                    ...
                    <div class="col-md-12" id="ic_pv_file">
                      <?php
                          ...
                          if(count($attachments) > 0){
                              ...
                              $file_html .= '<hr />';
                              echo changee_pur_html_entity_decode($file_html);
                          }
                       ?>
                    </div>
                ...
                <div class="modal-body">
                 ...
                 <p class="bold" id="signatureLabel"><?php echo _l('signature'); ?></p>
                  ...
                  <div class="modal-footer">
                   ...
                   <button onclick="sign_request(<?php echo changee_pur_html_entity_decode($contract->id); ?>);" data-loading-text="<?php echo _l('wait_text'); ?>" autocomplete="off" class="btn btn-success"><?php echo _l('e_signature_sign'); ?></button>
                  </div>
              </div><!-- /.modal-content -->
           </div><!-- /.modal-dialog -->
        </div><!-- /.modal -->
...
<div class="modal fade" id="send_contract" tabindex="-1" role="dialog">
  <div class="modal-dialog">
      <?php echo form_open_multipart(admin_url('changee/send_contract'),array('id'=>'send_contract-form')); ?>
...
<?php require 'modules/changee/assets/js/contract_js.php';?>
