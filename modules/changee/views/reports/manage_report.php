               ...
               <div class="panel-body">
	                 <div class="row">
	                     <div class="col-md-4 border-right">
	                      ...
	                      <hr class="hr-10" />
	                      <p><a href="#" class="font-medium" onclick="init_report(this,'changee_invoice_rp'); return false;"><i class="fa fa-caret-down" aria-hidden="true"></i> <?php echo _l('changee_invoice_rp'); ?></a></p>

	                  	 </div>
		                  <div class="col-md-4 border-right">
		                    <h4 class="no-margin font-medium"><i class="fa fa-area-chart" aria-hidden="true"></i> <?php echo _l('charts_based_report'); ?></h4>
		                    <hr />
		                    <p><a href="#" class="font-medium" onclick="init_report(this,'statistics_number_of_changee_orders'); return false;"><i class="fa fa-caret-down" aria-hidden="true"></i> <?php echo _l('changee_statistics_by_number_of_changee_orders'); ?></a></p>
		                    <hr class="hr-10" />
		                    <p><a href="#" class="font-medium" onclick="init_report(this,'statistics_cost_of_changee_orders'); return false;"><i class="fa fa-caret-down" aria-hidden="true"></i> <?php echo _l('changee_statistics_by_cost'); ?></a></p>
		                 </div>
		                 <div class="col-md-4">
			                ...
			                <?php } ?>
		                     ...
		                     <div class="form-group hide" id="year_requisition">
		                        ...
		                        <select  name="year_requisition" id="year_requisition"  class="selectpicker"  data-width="100%" data-none-selected-text="<?php echo _l('filter_by').' '._l('year'); ?>">
		                              <option value="<?php echo changee_pur_html_entity_decode($y0); ?>" <?php echo 'selected' ?>><?php echo _l('year').' '. changee_pur_html_entity_decode($y0) ; ?></option>
		                              <option value="<?php echo changee_pur_html_entity_decode($y1); ?>"><?php echo _l('year').' '. changee_pur_html_entity_decode($y1) ; ?></option>
		                              <option value="<?php echo changee_pur_html_entity_decode($y2); ?>"><?php echo _l('year').' '. changee_pur_html_entity_decode($y2) ; ?></option>
		                              <option value="<?php echo changee_pur_html_entity_decode($y3); ?>"><?php echo _l('year').' '. changee_pur_html_entity_decode($y3) ; ?></option>
			        ...
			        <div id="report" class="hide">
			          	...
			          	<div class="col-md-12">
		               		<?php $this->load->view('cost_changee_orders'); ?>
			          	</div>
			          	<div class="col-md-12">
		               		<?php $this->load->view('number_changee_orders'); ?>
			          	</div>
			          	<div class="col-md-12">
			          	...
			          	<div class="col-md-12">
			          		<?php $this->load->view('changee_inv_report'); ?>
			          	</div>
		            </div>
	            </div>      
              </div>
...
<?php require 'modules/changee/assets/js/changee_report_js.php';?>