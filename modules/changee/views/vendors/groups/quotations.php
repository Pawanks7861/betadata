<div class="col-md-12" id="small-table">
    ...
    <?php if (has_permission('changee_quotations', '', 'create') || is_admin()) { ?>
      <a href="<?php echo admin_url('changee/estimate?vendor='.$client->userid); ?>"class="btn btn-info pull-left mright10 display-block">
