    ...
    <table class="table dt-table">
      ...
      <tbody>
         <?php foreach($expenses as $p) { ?>
          <tr>
          <td><a href="<?php echo admin_url('expenses/list_expenses/' . $p['id']); ?>" ><?php echo changee_pur_html_entity_decode($p['category_name']); ?></a></td>
          <td><?php echo app_format_money($p['amount'],$base_currency->symbol); ?></td>
          <td><?php echo changee_pur_html_entity_decode($p['expense_name']); ?></td>
          <td><?php echo _d($p['date']); ?></td>
          <td><?php echo changee_pur_html_entity_decode($p['paymentmode']); ?></td>
         </tr>
         <?php } ?>
      </tbody>
   </table> 
