...
<div class="col-md-12">
    <h4><?php echo _l('vendor_statement_for').' '.changee_get_vendor_company_name($client->userid); ?></h4>
</div>
<div class="clearfix"></div>
            ...
            <div class="row">
               ...
               <div class="col-md-7">
                   <address>
                    ...
                    <?php echo changee_format_vendor_info($client, 'statement', 'billing'); ?>
                 </address>
             </div>
              ...
              <div class="row">
                ...
                <div class="col-md-12">
                  <div class="checkbox checkbox-primary">
                      ...
                      <label for="attach_pdf"><?php echo _l('attach_changee_changee_statement_pdf'); ?></label>
                  </div>
                </div>
