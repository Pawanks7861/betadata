<div class="col-md-12" id="small-table">
    ...
    <?php if (has_permission('changee_debit_notes', '', 'create') || is_admin()) { ?>
      <a href="<?php echo admin_url('changee/debit_note'); ?>"class="btn btn-info pull-left mright10 display-block">
