<div class="col-md-12" id="small-table">
	<div class="row">
      <h4 class="no-margin font-bold"><i class="fa fa-cart-plus" aria-hidden="true"></i> <?php echo _l('changee_order'); ?></h4>
      <hr />
  	</div> 
    <?php if (has_permission('changee_orders', '', 'create') || is_admin()) { ?>
      <a href="<?php echo admin_url('changee/pur_order?vendor='.$client->userid); ?>"class="btn btn-info pull-left mright10 display-block">
