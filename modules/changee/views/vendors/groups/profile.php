   ...
   <div class="col-md-12">
      ...
      <div class="tab-content">
               ...
               <div class="col-md-6">
                  ...
                  <div class="form-group">
                     ...
                     <div class="input-group">
                        <input type="text" name="website" id="website" value="<?php echo changee_pur_html_entity_decode($client->website); ?>" class="form-control">
                  ...
                  <div class="form-group">
                     ...
                     <select  name="category[]" id="category" class="selectpicker" data-live-search="true" multiple data-width="100%" data-none-selected-text="<?php echo _l('ticket_settings_none_assigned'); ?>">
                         <?php foreach ($vendor_categories as $vc) {?>
                           <option value="<?php echo changee_pur_html_entity_decode($vc['id']); ?>" <?php if(isset($client) && in_array($vc['id'], explode(',',$client->category))){ echo 'selected'; } ?>><?php echo changee_pur_html_entity_decode($vc['category_name']); ?></option>
                           <?php }?>
                     </select>
                  </div>
                  ...
                  <div class="form-group select-placeholder">
                     ...
                     <select name="default_language" id="default_language" class="form-control selectpicker" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
                        ...
                        <?php foreach($this->app->get_available_languages() as $availableLanguage){
                           ...
                           ?>
                        <option value="<?php echo changee_pur_html_entity_decode($availableLanguage); ?>" <?php echo changee_pur_html_entity_decode($selected); ?>><?php echo ucfirst($availableLanguage); ?></option>
                        <?php } ?>
                     </select>
                  </div>
                  <?php } ?>
         ...
         <div role="tabpanel" class="tab-pane" id="vendor_admins">
            <?php if (has_permission('changee_vendors', '', 'create') || has_permission('changee_vendors', '', 'edit')) { ?>
            ...
            <table class="table dt-table">
               ...
               <tbody>
                  ...
                  <tr>
                     ...
                     <td data-order="<?php echo changee_pur_html_entity_decode($c_admin['date_assigned']); ?>"><?php echo _dt($c_admin['date_assigned']); ?></td>
                     <?php if(has_permission('changee_vendors','','create') || has_permission('changee_vendors','','edit')){ ?>
                     <td>
                        <a href="<?php echo admin_url('changee/delete_vendor_admin/'.$client->userid.'/'.$c_admin['staff_id']); ?>" class="btn btn-danger _delete btn-icon"><i class="fa fa-remove"></i></a>
                     </td>
                     <?php } ?>
                  </tr>
                  <?php } ?>
...
<div class="modal fade" id="customer_admins_assign" tabindex="-1" role="dialog">
   <div class="modal-dialog">
      <?php echo form_open(admin_url('changee/assign_vendor_admins/'.$client->userid)); ?>
