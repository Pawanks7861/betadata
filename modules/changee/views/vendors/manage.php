            ...
            <div class="panel_s">
               <div class="panel-body">
                <div class="row">
                  <div class="col-md-4">
                  <div class="_buttons">
                     <?php if (has_permission('changee_vendors','','create')) { ?>
                     <a href="<?php echo admin_url('changee/vendor'); ?>" class="btn btn-info mright5 test pull-left display-block">
                     <?php echo _l('new_vendor'); ?></a>

                     <a href="<?php echo admin_url('changee/vendor_import'); ?>" class="btn btn-info mright5 test pull-left display-block">
                     <?php echo _l('import_vendors'); ?></a>

                     <a href="<?php echo admin_url('changee/all_contacts'); ?>" class="btn btn-info pull-left display-block mright5">
                        ...
                        <ul class="dropdown-menu dropdown-menu-left widthul">
                           ...
                           <li class="dropdown-submenu pull-left groups">
                              ...
                              <ul class="dropdown-menu dropdown-menu-left">
                                 ...
                                 <li><a href="#" data-cview="vendor_category_<?php echo changee_pur_html_entity_decode($group['id']); ?>" onclick="dt_custom_view('vendor_category_<?php echo changee_pur_html_entity_decode($group['id']); ?>','.table-vendors','vendor_category_<?php echo changee_pur_html_entity_decode($group['id']); ?>'); return false;"><?php echo changee_pur_html_entity_decode($group['category_name']); ?></a></li>
                                 <?php } ?>
                              </ul>
                           </li>
                           ...
                           <li class="dropdown-submenu pull-left groups">
                              <a href="#" tabindex="-1"><?php echo _l('changee_order'); ?></a>
                              <ul class="dropdown-menu dropdown-menu-left">
                                 <?php foreach($pur_order_status as $status){ ?>
                                 <li><a href="#" data-cview="pur_order_status_<?php echo changee_pur_html_entity_decode($status); ?>" onclick="dt_custom_view('pur_order_status_<?php echo changee_pur_html_entity_decode($status); ?>','.table-vendors','pur_order_status_<?php echo changee_pur_html_entity_decode($status); ?>'); return false;"><?php echo _l('contains_changee_order_by_status').' '.changee_get_status_approve_str($status); ?></a></li>
                                 <?php } ?>
                              </ul>
                           </li>
                           <div class="clearfix"></div>
                           ...
                           <li class="dropdown-submenu pull-left groups">
                              ...
                              <ul class="dropdown-menu dropdown-menu-left">
                                 ...
                                 <li><a href="#" data-cview="estimate_status_<?php echo changee_pur_html_entity_decode($status); ?>" onclick="dt_custom_view('estimate_status_<?php echo changee_pur_html_entity_decode($status); ?>','.table-vendors','estimate_status_<?php echo changee_pur_html_entity_decode($status); ?>'); return false;"><?php echo _l('contains_changee_estimate_by_status').' '.changee_get_status_approve_str($status); ?></a></li>
                                 <?php } ?>
                              </ul>
                           </li>
                           <div class="clearfix"></div>
                      ...
                      <div class="modal-dialog" role="document">
                         <div class="modal-content">
                            ...
                            <div class="modal-body">
                               <?php if(has_permission('changee_vendors','','delete') || is_admin()){ ?>
                            ...
                            <div class="modal-footer">
                               ...
                               <?php if(has_permission('changee_vendors','','delete') || is_admin()){ ?>
                               <a href="#" class="btn btn-info" onclick="changee_delete_bulk_action(this); return false;"><?php echo _l('confirm'); ?></a>
                                <?php } ?>
                            </div>
                         </div>
