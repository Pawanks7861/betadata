         ...
         <div class="col-md-12">
            <?php if(isset($client) && $client->registration_confirmed == 0 && is_admin()){ ?>
               <div class="alert alert-warning">
                  ...
                  <br />
                  <a href="<?php echo admin_url('changee/confirm_registration/'.$client->userid); ?>"><?php echo _l('confirm_registration'); ?></a>
               </div>
            <?php } ?>
   
            <?php if(isset($client) && (!has_permission('changee_vendors','','view') && changee_is_vendor_admin($client->userid))){?>
         ...
         <div class="col-md-3">
            <div class="panel_s mbot5">
               <div class="panel-body padding-10">
                  <h4 class="bold">
                     #<?php echo changee_pur_html_entity_decode($client->userid . ' ' . $title); ?>
...
<?php require 'modules/changee/assets/js/vendor_js.php';?>
