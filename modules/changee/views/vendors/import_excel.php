                  ...
                  <tr>
                    <?php
                      ...
                      for($i=0;$i<count($file_header);$i++){
                          if($i == 0  ||$i == 1 ||$i == 2 ||$i == 6){
                          ?>
                          <th class="bold"><span class="text-danger">*</span> <?php echo changee_pur_html_entity_decode($file_header[$i]) ?> </th>
                          <?php 
                          } else {
                          ?>
                          <th class="bold"><?php echo changee_pur_html_entity_decode($file_header[$i]) ?> </th>
...
<?php require 'modules/changee/assets/js/import_excel_vendor_js.php';?>
</body>
</html>
