...
<div class="modal fade" id="request_quotation" tabindex="-1" role="dialog">
  <div class="modal-dialog">
      <?php echo form_open_multipart(admin_url('changee/send_request_quotation'),array('id'=>'send_rq-form')); ?>
              ...
              <div class="row">
                <div class="col-md-12 form-group">
                  <label for="send_to"><span class="text-danger">* </span><?php echo _l('send_to'); ?></label>
                    <select name="send_to[]" id="send_to" class="selectpicker" required multiple="true"  data-live-search="true" data-width="100%" data-none-selected-text="<?php echo _l('ticket_settings_none_assigned'); ?>" >
                        ...
                        <option value="<?php echo changee_pur_html_entity_decode($s['email']); ?>" data-subtext="<?php echo changee_pur_html_entity_decode($s['firstname'].' '.$s['lastname'].' - '. changee_get_vendor_company_name($s['userid'])); ?>" selected><?php echo changee_pur_html_entity_decode($s['email']); ?></option>
                          <?php } ?>
                    </select>
                    <br>
                </div>     
                <div class="col-md-12">
                  <div class="checkbox checkbox-primary">
                      ...
                      <label for="attach_pdf"><?php echo _l('attach_changee_request_pdf'); ?></label>
                  </div>
                </div>
...
<div class="modal fade" id="share_request" tabindex="-1" role="dialog">
  <div class="modal-dialog">
      <?php echo form_open_multipart(admin_url('changee/share_request'),array('id'=>'share_request-form')); ?>
      <div class="modal-content modal_withd">
          <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
              <h4 class="modal-title">
