		...
		<div class="panel_s">
			<div class="panel-body">
				<div class="row">
					<div class="col-md-12">
						<h4>
	                      <?php echo changee_pur_html_entity_decode($item->description); ?>
	                   	</h4>
			          ...
			          <table class="table border table-striped table-margintop">
			              <tbody>
			                 ...
			                 <tr class="project-overview">
			                    ...
			                    <td><?php echo changee_get_group_name_pur(changee_pur_html_entity_decode($item->group_id)) != null ? changee_get_group_name_pur(changee_pur_html_entity_decode($item->group_id))->name : '' ; ?></td>
			                 </tr>
			                 <tr class="project-overview">
			                 ...
			                 <tr class="project-overview">
			                    ...
			                    <td><?php echo changee_pur_html_entity_decode($item->tax) != '' && changee_pur_get_tax_rate($item->tax) != null ? changee_pur_get_tax_rate($item->tax)->name : '';  ?></td>
			                 </tr> 
			                 <tr class="project-overview">
			                    <td class="bold"><?php echo _l('tax_2'); ?></td>
			                    <td><?php echo changee_pur_html_entity_decode($item->tax2) != '' && changee_pur_get_tax_rate($item->tax2) != null ? changee_pur_get_tax_rate($item->tax2)->name : '';  ?></td>
			                 </tr> 
			                 <tr class="project-overview">
			            ...
			            <div class="wrapper-masonry">
			              <div id="masonry" class="masonry-layout columns-2">
					            ...
					            <?php if(isset($commodity_file) && count($commodity_file) > 0){ ?>
					              <?php foreach ($commodity_file as $key => $value) { ?>
					                  ...
					                  <?php if(file_exists(PURCHASE_MODULE_UPLOAD_FOLDER.'/vendor_items/' .$value["rel_id"].'/'.$value["file_name"])){ ?>
					                      <a  class="images_w_table" href="<?php echo site_url('modules/changee/uploads/vendor_items/'.$value["rel_id"].'/'.$value["file_name"]); ?>"><img class="images_w_table" src="<?php echo site_url('modules/changee/uploads/vendor_items/'.$value["rel_id"].'/'.$value["file_name"]); ?>" alt="<?php echo changee_pur_html_entity_decode($value['file_name']) ?>"/></a>
					          ...
					          <?php }else{ ?>
					                ...
					                <a class="images_w_table" href="<?php echo site_url('modules/changee/uploads/nul_image.jpg'); ?>"><img class="images_w_table" src="<?php echo site_url('modules/changee/uploads/nul_image.jpg'); ?>" alt="nul_image.jpg"/></a>
