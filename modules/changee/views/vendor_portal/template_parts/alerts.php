...
<?php if(changee_is_vendor_logged_in() && $navigationEnabled){
        ...
        <div class="panel-body announcement mbot15 tc-content">
            <div class="text-info alert-dismissible" role="alert">
                ...
                <h4 class="bold no-margin font-medium">
                    ...
                    <hr />
                    <h4 class="bold font-medium announcement-name"><?php echo changee_pur_html_entity_decode($__announcement['name']); ?></h4>
