...
<div class="mtop40">
   ...
   <div class="col-md-4 col-md-offset-4 col-sm-8 col-sm-offset-2">
      <?php echo form_open(site_url('changee/authentication_vendor/login'),array('class'=>'login-form')); ?>
         ...
         <div class="panel-body">
            ...
            <div class="form-group">
               ...
               <?php if(get_option('allow_vendors_to_register') == 1){ ?>
                  <a href="<?php echo site_url('changee/authentication_vendor/register'); ?>" class="btn btn-success btn-block"><?php echo _l('clients_register_string'); ?></a>
               <?php } ?>
            </div>
            <?php echo form_close(); ?>
         </div>
