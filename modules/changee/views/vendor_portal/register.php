...
<div class="col-md-10 col-md-offset-1">
    <?php echo form_open('changee/authentication_vendor/register', ['id'=>'register-form']); ?>
    <div class="panel_s">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group register-country-group">
                        ...
                        <select data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>" data-live-search="true" name="country" class="form-control" id="country">
                            ...
                            <option value="<?php echo changee_pur_html_entity_decode($country['country_id']); ?>"<?php if(get_option('customer_default_country') == $country['country_id']){echo ' selected';} ?> <?php echo set_select('country', $country['country_id']); ?>><?php echo changee_pur_html_entity_decode($country['short_name']); ?></option>
                            <?php } ?>
                        </select>
                    </div>
                    ...
                    <div class="text-center">
                        <div class="checkbox">
                            ...
                            <label for="accept_terms_and_conditions">
                                <?php echo _l('gdpr_terms_agree', site_url('changee/vendors_portal/terms_and_conditions')); ?>
                            </label>
                        </div>
