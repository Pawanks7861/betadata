...
<?php if($pur_order->currency != 0){
  $base_currency = changee_pur_get_currency_by_id($pur_order->currency);
}
 ?>
<div id="wrapper">
  <div class="content">
        ...
        <div class="panel-body">
          ...
          <div class="tab-content">
             <div role="tabpanel" class="tab-pane ptop10 <?php if($this->input->get('tab') != 'discussion' && $this->input->get('tab') != 'attachment'){echo 'active';} ?>" id="general_infor">
              <div class="row">
                <?php if($pur_order->order_status == 'new' && changee_is_vendor_logged_in()){ ?>
                  <div class="col-md-12">
                    <a href="javascript:void(0)" onclick="confirm_order(this); return false;" class="btn btn-info pull-right" data-order_id="<?php echo changee_pur_html_entity_decode($pur_order->id); ?>" data-toggle="tooltip" data-placement="top" title="<?php echo _l('pur_confirm_order_note'); ?>"><?php echo _l('pur_confirm'); ?></a>
                    </div>
                  <?php } ?>
               ...
               <div class="col-md-6">
                  ...
                  <table class="table table-striped table-bordered">
                    <tr>
                      ...
                      <td><?php echo changee_pur_html_entity_decode($pur_order->pur_order_number) ?></td>
                    </tr>
                    <tr>
                      <td><?php echo _l('pur_order_name'); ?></td>
                      <td><?php echo changee_pur_html_entity_decode($pur_order->pur_order_name) ?></td>
                    </tr>
                    <tr>
                      <td><?php echo _l('pur_approve_status'); ?></td>
                      <td><?php echo changee_get_status_approve($pur_order->approve_status) ?></td>
                    </tr>
                  </table>
               </div>
               <div class="col-md-6">
                  <table class="table table-striped table-bordered">
                    ...
                    <tr>
                      ...
                      <td><?php echo changee_pur_render_date_input('delivery_date', '', _d($pur_order->delivery_date), array('onchange' => 'update_delivery_date(this); return false;')); ?></td>
                    </tr>
                    <tr>
            ...
            <div role="tabpanel" class="tab-pane <?php if($this->input->get('tab') === 'attachment'){echo ' active';} ?>" id="attachment">
              <?php echo form_open_multipart(site_url('changee/vendors_portal/upload_files/'.$pur_order->id),array('class'=>'dropzone','id'=>'files-upload')); ?>
                  ...
                  <td data-order="<?php echo $file['dateadded']; ?>"><?php echo _dt($file['dateadded']); ?></td>
                      ...
                      <td>
                          <?php if($file['contact_id'] == changee_get_vendor_contact_user_id()){ ?>
                              <a href="<?php echo site_url('changee/vendors_portal/delete_po_file/'.$file['id'].'/'.$pur_order->id); ?>"
        ...
        <div class="col-md-12">
             ...
             <table class="table items items-preview estimate-items-preview" data-type="estimate">
                ...
                <tbody class="ui-sortable">
                   ...
                   <tr nobr="true" class="sortable">
                      ...
                      $item = changee_get_item_hp2($es['item_code']); 
         ...
         <?php if($pur_order->vendornote != ''){ ?>
           ...
           <div class="col-md-12 mtop15">
              ...
              <p><?php echo changee_pur_html_entity_decode($pur_order->terms); ?></p>
           </div>
           <?php } ?>
...
<?php require 'modules/changee/assets/js/pur_order_vendor_js.php';?>
