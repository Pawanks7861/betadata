...
<div class="row">
	<?php echo form_open_multipart(site_url('changee/vendors_portal/pur_invoice_form'),array('id'=>'pur_invoice-form','class'=>'_pur_invoice_form _transaction_form')); ?>
	<?php
		if(isset($pur_order)){
            ...
            <div class="row">
	               ...
	               <div class="col-md-6 form-group pad_left_0  pad_right_0">
	                ...
	                <div class="col-md-6 pad_left_0 ">
	                	...
	                	<?php $invoice_date = ( isset($pur_invoice) ? _d($pur_invoice->invoice_date) : _d(date('Y-m-d')) );
	                	 echo changee_pur_render_date_input('invoice_date','',$invoice_date,array( 'required' => 'true')); ?>
	                </div>

	                <div class="col-md-6 pad_left_0 pad_right_0">
	                	<label for="invoice_date"><?php echo _l('pur_due_date'); ?></label>
	                	<?php $duedate = ( isset($pur_invoice) ? _d($pur_invoice->duedate) : _d(date('Y-m-d')) );
	                	 echo changee_pur_render_date_input('duedate','',$duedate); ?>
	                </div>
	            ...
	            <div class="col-md-6">
	                ...
	                <div class="col-md-6 pad_right_0">
	                	...
	                	echo changee_pur_render_date_input('transaction_date','transaction_date',$transaction_date); ?>
	                </div>
			...
			<div class="panel-body mtop10 invoice-item">
		        ...
		        <div class="row">
		          ...
		          <?php
			              ...
			              if($vendor_currency != 0 && !isset($pur_invoice)){
			                $inv_currency = changee_pur_get_currency_by_id($vendor_currency);
			              }

			              if(isset($pur_invoice) && $pur_invoice->currency != 0){
			                $inv_currency = changee_pur_get_currency_by_id($pur_invoice->currency);
			              } 
...
<?php require 'modules/changee/assets/js/vendor_pur_invoice_js.php';?>