	...
	<div class="col-md-12">
		<div class="panel_s">
			<div class="panel-body">
				...
				<hr class="mtop5">
				<a href="<?php echo site_url('changee/vendors_portal/add_update_invoice'); ?>" class="btn btn-info"><?php echo _l('add_new'); ?></a>
				<br><br>
			      ...
			      <tbody>
			         <?php foreach($invoices as $inv) { ?>
			         	<?php 
			         		...
			         		if($inv['currency'] != 0){
			         			$base_currency = changee_pur_get_currency_by_id($inv['currency']);
			         		}
			         	?>
			         <tr class="inv_tr">
			         	<td class="inv_tr"><a href="<?php echo site_url('changee/vendors_portal/invoice/'.$inv['id']); ?>"><?php echo changee_pur_html_entity_decode($inv['invoice_number']); ?></a></td>
			         	<td class="inv_tr"><?php 
			         	...
			         	?></td>
			         	<td class="inv_tr"><?php echo changee_get_pur_contract_number($inv['contract'],''); ?></td>
			         	<td class="inv_tr"><?php echo changee_get_pur_order_subject($inv['pur_order']); ?></td>
			            ...
			            echo  '<span class="label label-'.$class.' s-status invoice-status-3">'._l($inv['payment_status']).'</span>';
			         	...
			         	<td>
			         		<a href="<?php echo site_url('changee/vendors_portal/add_update_invoice/'.$inv['id']); ?>" class="btn btn-warning btn-icon"><i class="fa fa-pencil"></i></a>
			         		<a href="<?php echo site_url('changee/vendors_portal/delete_invoice/'.$inv['id']); ?>" class="btn btn-danger btn-icon _delete"><i class="fa fa-remove"></i></a>
			         	</td>
			         </tr>
			         <?php } ?>
			      </tbody>
