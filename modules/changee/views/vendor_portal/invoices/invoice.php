...
<div class="row">
	<?php 
		...
		if($pur_invoice->currency != 0){
			$base_currency = changee_pur_get_currency_by_id($pur_invoice->currency);
		}
	?>
	<div class="col-md-12">
		<div class="panel_s">
			<div class="panel-body">
				<h4 class="mtop5"><?php echo changee_pur_html_entity_decode($title); ?></h4>
             		...
             		<div role="tabpanel" class="tab-pane ptop10 <?php if($this->input->get('tab') != 'discussion'){echo 'active';} ?>" id="general_infor">
						<div class="col-md-12 pad_left_0">
							<div class="col-md-6 pad_left_0 border-right align_div">
								<p><?php echo _l('invoice_code').':'; ?><span class="pull-right bold"><?php echo changee_pur_html_entity_decode($pur_invoice->invoice_number); ?></span></p>
							</div>
							...
							<div class="col-md-6 pad_left_0 border-right align_div">
								<p><?php echo _l('invoice_number').':'; ?><span class="pull-right bold">
									...
									echo changee_pur_html_entity_decode($vendor_invoice_number); ?>
									</span></p>
							</div>
						...
						<div class="col-md-12 pad_left_0">
							<div class="col-md-6 pad_left_0 border-right align_div">
								<p><?php echo _l('transaction_id').':'; ?><span class="pull-right bold"><?php echo changee_pur_html_entity_decode($pur_invoice->transactionid); ?></span></p>
							</div>
							<div class="col-md-6 pad_right_0 align_div">
							...
							<div class="col-md-6 pad_left_0 border-right align_div">
								...
								<p><?php echo _l('contract').':'; ?><span class="pull-right bold"><a href="<?php echo site_url('changee/vendors_portal/view_contract/'.$pur_invoice->contract); ?>" ><?php echo changee_get_pur_contract_number($pur_invoice->contract); ?></a></span></p>
								<?php }else{ ?>
								<p><?php echo _l('pur_order').':'; ?><span class="pull-right bold"><a href="<?php echo site_url('changee/vendors_portal/pur_order/'.$pur_invoice->pur_order); ?>" ><?php echo changee_get_pur_order_subject($pur_invoice->pur_order); ?></a></span></p>	
								<?php } ?>
							</div>
	                           ...
	                           <table class="table items items-preview estimate-items-preview" data-type="estimate">
	                              ...
	                              <tbody class="ui-sortable">
	                                 ...
	                                 <tr nobr="true" class="sortable">
	                                    ...
	                                    ?></strong><?php if($es['description'] != ''){ ?><br><span><?php echo changee_pur_html_entity_decode($es['description']); ?></span><?php } ?></td>
						...
						<div class="col-md-12 pad_left_0 pad_right_0 align_div">
							<p><span class="bold"><?php echo _l('pur_note').': '; ?></span><span><?php echo changee_pur_html_entity_decode($pur_invoice->vendor_note); ?></span></p>
						</div>
						<div class="col-md-12 pad_left_0 pad_right_0">
							<hr class="mtop5 mbot5">
						</div>
						<div class="col-md-12 pad_left_0 pad_right_0 align_div">
							<p><span class="bold"><?php echo _l('terms').': '; ?></span><span><?php echo changee_pur_html_entity_decode($pur_invoice->terms); ?></span></p>
						</div>
						<div class="col-md-12 pad_left_0 pad_right_0">
							<hr class="mtop5 mbot5">
						</div>
						<div class="col-md-12 pad_left_0 pad_right_0 align_div">
							<p><span class="bold"><?php echo _l('client_note').': '; ?></span><span><?php echo changee_pur_html_entity_decode($pur_invoice->adminnote); ?></span></p>
						</div>
					</div>
