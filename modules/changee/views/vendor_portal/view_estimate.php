        ...
        <div class="panel-body">
          ...
          <div class="tab-content">
               ...
               <div class="col-md-6">
                  ...
                  <table class="table table-striped table-bordered">
                    <tr>
                      ...
                      <td><?php echo changee_format_pur_estimate_number($estimate->id) ?></td>
                    </tr>
            ...
            <div role="tabpanel" class="tab-pane <?php if($this->input->get('tab') === 'attachment'){echo ' active';} ?>" id="attachment">
              <?php echo form_open_multipart(site_url('changee/vendors_portal/upload_estimate_files/'.$estimate->id),array('class'=>'dropzone','id'=>'files-upload')); ?>
                  ...
                  <td data-order="<?php echo $file['dateadded']; ?>"><?php echo _dt($file['dateadded']); ?></td>
                      ...
                      <td>
                          <?php if($file['contact_id'] == changee_get_vendor_contact_user_id()){ ?>
                              <a href="<?php echo site_url('changee/vendors_portal/delete_estimate_file/'.$file['id'].'/'.$estimate->id); ?>"
        ...
        <div class="col-md-12">
         ...
         <?php if($estimate->vendornote != ''){ ?>
           <div class="col-md-12 mtop15">
              ...
              <p><?php echo changee_pur_html_entity_decode($estimate->vendornote); ?></p>
           </div>
           <?php } ?>
