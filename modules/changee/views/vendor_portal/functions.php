 ...
 */
hooks()->add_action('changee_app_vendor_head', 'changee_app_theme_vendor_head_hook');

/**
 * Default theme menu items
 * In most cases you will want to add this hook because of all the features
 */
changee_register_theme_vendor_assets_hook('theme_vendor');
