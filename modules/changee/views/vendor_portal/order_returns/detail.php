...
<?php if($order_return->currency != 0){
  $base_currency = changee_pur_get_currency_by_id($order_return->currency);
}
 ?>
<div id="wrapper">
  <div class="content">
             ...
             <div role="tabpanel" class="tab-pane ptop10 active" id="general_infor">
              <div class="row">
                <?php if($order_return->status == 'draft' ){ ?>
                  <div class="col-md-12">
                  	<a href="javascript:void(0)" onclick="reject_order(this); return false;" class="btn btn-danger pull-right mbot10" data-order_id="<?php echo changee_pur_html_entity_decode($order_return->id); ?>" ><?php echo _l('reject'); ?></a>

                    <a href="javascript:void(0)" onclick="confirm_order(this); return false;" class="btn btn-info pull-right mbot10 mright5" data-order_id="<?php echo changee_pur_html_entity_decode($order_return->id); ?>" ><?php echo _l('confirm'); ?></a>
               ...
               <div class="col-md-6">
                  ...
                  <table class="table table-striped table-bordered">
                    <tr>
                      ...
                      <td><?php echo changee_pur_html_entity_decode($order_return->order_return_name) ?></td>
                    </tr>
                    <tr>
...
<?php require 'modules/changee/assets/js/order_returns/order_return_vendor_js.php';?>
