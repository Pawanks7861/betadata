			      ...
			      <tbody>
			         <?php foreach($order_returns as $or) { ?>
			         	<?php 
			         		...
			         		if($or['currency'] != 0){
			         			$base_currency = changee_pur_get_currency_by_id($or['currency']);
			         		}
			         	?>
			         <tr class="inv_tr">
			         	<td class="inv_tr"><a href="<?php echo site_url('changee/vendors_portal/order_return/'.$or['id']); ?>"><?php echo changee_pur_html_entity_decode($or['order_return_name']); ?></a></td>
