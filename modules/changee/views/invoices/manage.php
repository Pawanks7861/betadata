            ...
            <div class="row">
                    ...
                    <div class="row">    
                          <div class="_buttons col-md-12">
                            <?php if (has_permission('changee_invoices', '', 'create') || is_admin()) { ?>
                            <a href="<?php echo admin_url('changee/pur_invoice'); ?>"class="btn btn-info pull-left mright10 display-block">
                                <?php echo _l('new'); ?>
                            </a>
                            <?php } ?>
                            <div class="col-md-2">
                            ...
                            <div class="col-md-2 form-group">
                              ...
                              <select name="contract[]" id="contract" class="selectpicker" multiple="true"  data-live-search="true" data-width="100%" data-none-selected-text="<?php echo _l('contract'); ?>">
                                 <?php foreach($contracts as $ct){ ?>
                                  <option value="<?php echo changee_pur_html_entity_decode($ct['id']); ?>" ><?php echo changee_pur_html_entity_decode($ct['contract_number']); ?></option>
                                 <?php } ?>
                              </select>
