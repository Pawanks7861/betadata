   ...
   <div class="modal-dialog full-screen-modal dialog_withd" role="document">
      <div class="modal-content">
         <div class="modal-header">
            ...
            <h4 class="modal-title"><?php echo changee_pur_html_entity_decode($file->file_name); ?></h4>
         </div>
            ...
            <div class="row">
               <div class="col-md-12 border-right project_file_area">
                  ...
                  <?php } else if(is_markdown_file($path) && $previewMarkdown = markdown_parse_preview($path)) {
                     echo changee_pur_html_entity_decode($previewMarkdown);
                  } else {
...
<?php require 'modules/changee/assets/js/_file_js.php';?>
